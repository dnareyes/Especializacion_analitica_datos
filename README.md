...
- [Estadística para analitica de datos/data/raw/](Estad%C3%ADstica%20para%20analitica%20de%20datos/data/raw/): datos originales usados para el análisis.
- [Estadística para analitica de datos/data/processed/](Estad%C3%ADstica%20para%20analitica%20de%20datos/data/processed/): datos limpios o derivados.
- [Estadística para analitica de datos/src/](Estad%C3%ADstica%20para%20analitica%20de%20datos/src/): scripts de apoyo y utilidades.

## Notas

- Si usas un CSV en lugar de Excel, verifica que los nombres de las columnas coincidan con los esperados por la app.
- El modelo lineal y el HistGradientBoosting trabajan sobre el objetivo transformado en logaritmo para estabilizar la variabilidad.
- El notebook contiene código más detallado que la app; la app está pensada como una versión resumida e interactiva del análisis.
